...
namespace Presentation.Common
{
    ...
    public abstract class OutlineInteractable : MonoBehaviour, IInteractable
    {
        ...
        public virtual void OnHoverEnter<T>(IInteractor<T> interactor) where T : BaseModel
        {
        ...
        public virtual void OnHoverStay<T>(IInteractor<T> interactor) where T : BaseModel
        {
            bool canInteract = CanInteract(interactor); 
            UpdateOutlineColor(canInteract);
        }
